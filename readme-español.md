...
Esta es una aplicación web creada para organizar el sorteo de la Copa Mundial 2026 en Estados Unidos, Mexico y Canada

Cómo funciona El proyecto está construido utilizando HTML y JavaScript puros (sin utilizar marcos extraños) y utiliza una base de datos Supabase que es gratuita y basada en la nube para almacenar las predicciones

Pasos para jugar: 1ro Abre el archivo «index.html» en su navegador (Chrome, Edge, el que funcione) 2do Introduzca su nombre 3ri Rellene los resultados de los grupos A a L 4to ATENCIÓN: En la fase eliminatoria, si predice un empate, debe marcar la casilla de verificación de quién gana en los penaltis. 5to Por último, elija el campeón, el subcampeón, el tercer clasificado y el equipo con más goles 6to Pulse el botón amarillo para guardar
...
7. Abra el archivo html de administración en su ordenador y actualice el resultado de los partidos para que el software pueda realizar los cálculos necesarios para actualizar las tablas de clasificación ( la contraseña es "admin1232" )
